...
if (passTo==="Github"){
  return( 
    <svg class="svg-icon svg-icon-marginGithub" aria-hidden="true" viewBox="0 0 1024 770.3333740234375">	
...
if (passTo==="Resume"){
  return( 
<svg class="svg-icon svg-icon-marginResume" aria-hidden="true" viewBox="0 0 20 20">
