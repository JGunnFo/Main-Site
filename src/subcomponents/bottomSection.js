...
if (passTo==="Github"){
  return( 
    <svg className="svg-icon svg-icon-marginHigher" aria-hidden="true" viewBox="0 0 1024 770.3333740234375">	
...
if (passTo==="Resume"){
  return( 
<svg className="svg-icon svg-icon-marginHigher" aria-hidden="true" viewBox="0 0 20 20">
