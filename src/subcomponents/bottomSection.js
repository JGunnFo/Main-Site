...
function selectSVG(passTo){
  ...
  if (passTo==="Bio"){
    return( 
    <svg className="svg-icon svg-icon-marginNorm" aria-hidden="true" viewBox="0 0 20 20">
...
if (passTo==="Github"){
  return( 
    <svg className="svg-icon svg-icon-marginGithub" aria-hidden="true" viewBox="0 0 1024 770.3333740234375">	
...
if (passTo==="Resume"){
  return( 
<svg className="svg-icon svg-icon-marginResume" aria-hidden="true" viewBox="0 0 20 20">
  ...
  function switchForSection(passTo, props){
    ...
    if (props.section===passTo){
      navStyle="Nav-Selected asText Default-Styling "
    } else {
      navStyle="Nav-Unselected asText Default-Styling"
    }
